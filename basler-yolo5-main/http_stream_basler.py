...
# icam.GainAuto.SetValue("Continuous")
# icam.ExposureAuto.SetValue("Continuous")
# icam.BalanceWhiteAuto.SetValue("Continuous")

# icam.Open()
# icam.PixelFormat = "BayerGR8"
# icam.PixelFormat = "BGR8packed"
